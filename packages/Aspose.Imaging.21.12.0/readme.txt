...
API Reference : https://apireference.aspose.com/imaging/net/aspose.imaging
Product page: https://products.aspose.com/imaging/net
Github page: https://github.com/aspose-imaging/Aspose.Imaging-for-.NET
...
New Features & Enhancements in Version 21.12

- File extension aware Image Save

For the detailed notes, please visit https://docs.aspose.com/imaging/net/aspose-imaging-for-net-21-12-release-notes/.

Now you can read & Write Image Formats. 
...
Read Image Formats
Various: DICOM, DjVu, DNG, ODG, CMX, CDR, DIB, OTG, FODG, EPS, TGA, DXF.

Platform Independence
Aspose.Imaging for .NET can be used to develop applications on Windows Desktop (x86, x64), Windows Server (x86, x64), Windows Azure. Also Aspose.Imaging is Linux compatible. The supported platforms include .NET Framework version 2.0 or higher.

Need more details ?
We've collected them at https://docs.aspose.com/display/imagingnet/Home